...
const getIdentity = async (name, keypair) => new Identity({
  name,
  priv: keypair,
  pubkey: keypair.public,
  block: await Block.encode({ value: await signIdentity(keypair, keypair.public), codec, hasher })
})
